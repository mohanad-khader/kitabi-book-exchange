...
!(function (t, e) {
        ...
        q = (t, e = 'hide') => {
            ...
            P.on(document, i, `[data-bs-dismiss="${n}"]`, function (i) {
                if (
                    ...
                    return
                const s =
                    R.getElementFromSelector(this) || this.closest(`.${n}`)
    ...
    function Pe (t) {
        for (
            var e = ge(t), i = Ne(t);
            i && De(i) && 'static' === Se(i).position;

        )
            i = Ne(i)
        return i &&
            ('html' === me(i) ||
                ('body' === me(i) && 'static' === Se(i).position))
            ? e
            : i ||
                  (function (t) {
                ...
                if ('click' === e)
                    P.on(
                        ...
                        t => {
                            ...
                            ;(e._activeTrigger[hs] = !(
                                e._isShown() && e._activeTrigger[hs]
                            )),
                                e.toggle()
                        }
                    )
                    ...
                    P.on(this._element, t, this._config.selector, t => {
                        const e = this._initializeOnDelegatedTarget(t)
                        ;(e._activeTrigger['focusin' === t.type ? cs : ls] =
                            !0),
                            e._enter()
                    }),
